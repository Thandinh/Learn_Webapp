                ...
                <div id="main" class="allProducts">
                    <div class="grid wide">
                        <div class="navig">
                            ...
                            <a class="item active" href="">${category.name}</a>
                        </div>
                        ...
                        <div class="row row-main">
                                ...
                                <div class="row products">
                                    <c:forEach var="product" items="${productList}">
                                        <div class="col l-4">
                                            <div class="item">
                                                <div class="box-img">
                                                    <a href="chi-tiet-san-pham?productId=${product.id}">
                                                        <img src="${product.thumbnail}" alt="${product.name}">
                                                        <div class="hover-overlay">
                                                            <div class="hover-overlay__box-icon">
                                                                <div class="hover-overlay__eye"><i
                                                                        class="fa-solid fa-eye"></i></div>
                                                                <div class="hover-overlay__bag"><i
                                                ...
                                                <h3 class="nameProduct">
                                                    <a
                                                        href="chi-tiet-san-pham?productId=${product.id}">${product.name}</a>
                                                </h3>
                                                <div>
                            ...
                            <div class="col l-3">
                                ...
                                <div class="box mb-35">
                                    ...
                                    <div class="content">
                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="duoi100">
                                            <span></span> Giá dưới 100.000đ
                                        </label>

                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="100den200">
                                            <span></span> 100.000đ - 200.000đ
                                        </label>

                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="200den300">
                                            <span></span> 200.000đ - 300.000đ
                                        </label>

                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="300den400">
                                            <span></span> 300.000đ - 400.000đ
                                        </label>

                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="400den500">
                                            <span></span> 400.000đ - 500.000đ
                                        </label>

                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="500den1trieu">
                                            <span></span> 500.000đ - 1.000.000đ
                                        </label>

                                        <label for="" class="custom-checkbox">
                                            <input type="radio" name="price" value="tren1trieu">
                                            <span></span> Giá trên 1.000.000đ
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <div class="content">
                                        <div class="color-picker">
                                            <label class="color-option yellow">
                ...
                <%@include file="./inc/footer.jsp" %>
                    ...
                    <script>
                        ...
                        radioFilterPrice.forEach(radio => {
                            radio.addEventListener('click', (event) => {
                                ...
                                if (isChecked && radio.dataset.wasChecked === 'true') {
                                    ...
                                    // Cập nhật trạng thái cho các radio khác trong nhóm
                        ...
                        document.addEventListener("DOMContentLoaded", function () {
                            // Lặp qua tất cả các phần tử có class "price-sale"
                            document.querySelectorAll(".price-sale").forEach(elem => {
                                const value = parseInt(elem.textContent);
                                if (!isNaN(value)) {
                                    elem.textContent = formatPrice(value) + "₫";
                                }
                            });
