...
<body>
    ...
    <div id="main" class="register">
        <div class="container">
            ...
            <form action="dang-ky" id="register-form" class="form" method="post">
                ...
                <div class="form-group">
                    <input name="password_confirmation" type="password" rules="required|confirm:input[name='password']"
