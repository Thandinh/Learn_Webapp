        ...
        <div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <a href="<c:url value='admin-category?action=index' />"><i style="font-size: 20px; padding: 15px;" class="fa-solid fa-arrow-left"></i></a>
                                ...
                                <div class="basic-form">
                                    <form action="<c:url value='admin-category' />" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>Name: </label>
                                            <input type="text" class="form-control input-default" name="name" placeholder="name" value="${category.name}">
                                        </div>
