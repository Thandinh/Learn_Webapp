                                ...
                                <div class="basic-form">
                                    <form action="<c:url value='admin-product' />" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Name: </label>
                                            <input type="text" class="form-control input-default" name="name" value="${product.name}" placeholder="name">
                                        </div>

                                        <div class="form-group">
                                            <label>Description: </label>
                                            <textarea class="form-control" rows="4" id="comment" name="description" placeholder="description">${product.description}</textarea>
                                        </div>

                                        <label>Thumbnail: </label> <br>
                                        <img class="mb-2" src="<c:url value='${product.thumbnail}' />" width="150" height="150" alt="Ảnh Sản phẩm">
                                        ...
                                        <div class="form-group">
                                            <label>Price: </label>
                                            <input type="number" class="form-control input-default" name="price" value="${product.price}" placeholder="price (VND)">
                                        </div>

                                        <div class="form-group">
                                            <label>Price Sale: </label>
                                            <input type="number" class="form-control input-default " name="pricesale" value="${product.pricesale}" placeholder="price sale (VND)">
                                        </div>

                                        <div class="form-group">
                                            <label>Quantity: </label>
                                            <input type="number" class="form-control input-default " name="quantity" value="${product.quantity}" placeholder="quantity">
                                        </div>
